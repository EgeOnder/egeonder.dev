...
export type HelloOwnProps = {
  speed?: number;
  onAnimationComplete?: () => void;
};

export type HelloProps = ComponentProps<typeof motion.svg> & HelloOwnProps;

function Hello({ className, speed = 1, onAnimationComplete, ...props }: HelloProps) {
